...
class TutorialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post tutorials_url, params: { tutorial: { category: @tutorial.category, content: @tutorial.content, description: @tutorial.description, thumbnail: @tutorial.thumbnail, title: @tutorial.title, user_id: @tutorial.user_id } }
    end
  ...
  test "should update tutorial" do
    patch tutorial_url(@tutorial), params: { tutorial: { category: @tutorial.category, content: @tutorial.content, description: @tutorial.description, thumbnail: @tutorial.thumbnail, title: @tutorial.title, user_id: @tutorial.user_id } }
